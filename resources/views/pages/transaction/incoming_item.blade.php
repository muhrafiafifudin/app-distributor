        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Barang Masuk
                        <!--begin::Separator-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Barang Masuk</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Menampilkan semua barang masuk yang ada</span>
                            </h3>
                            <div class="card-toolbar">
                                <div class="button-add">
                                    ...
                                    <!--end::Svg Icon-->Tambah Barang Masuk</a>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                            ...
                                            <div class="mb-13 text-center">
                                                <h1 class="mb-3">TAMBAH BARANG MASUK</h1>
                                                <div class="text-gray-400 fw-bold fs-5">Form Untuk Menambah Data Barang Masuk</div>
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Scroll-->
                                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                <!--begin:Form-->
                                                <form class="form" action="{{ route('incoming-item.store') }}" method="POST" enctype="multipart/form-data" >
                                                    @csrf
                                                    @method('POST')
                                                    ...
                                                    <!--begin::Input group-->
                                                    <div class="d-flex flex-column mb-5 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">Barang</label>
                                                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih Barang" name="item_id">
                        ...
                        <div class="card-body py-3 pt-10">
                            ...
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table id="incoming_item_table" class="table table-striped border rounded gy-5 gs-7 dataTable no-footer">
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('incoming-item.destroy', \Crypt::encrypt($incoming_item->id)) }}" method="post">
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_item_{{ $incoming_item->id }}" >
                                ...
                                @foreach ($incoming_items as $incoming_item)
                                    <!--begin::Modal - New Target-->
                                    <div class="modal fade" id="modal_edit_item_{{ $incoming_item->id }}" tabindex="-1" aria-hidden="true">
                                        <!--begin::Modal dialog-->
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <!--begin::Modal content-->
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                    <!--begin::Heading-->
                                                    <div class="mb-13 text-center">
                                                        <h1 class="mb-3">EDIT BARANG BARU</h1>
                                                        <div class="text-gray-400 fw-bold fs-5">Form Untuk Mengubah Data Barang Baru</div>
                                                    </div>
                                                    <!--end::Heading-->
                                                    <!--begin::Scroll-->
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                        <!--begin:Form-->
                                                        <form class="form" action="{{ route('incoming-item.update', \Crypt::encrypt($incoming_item->id)) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">Jumlah</label>
                                                                <input type="text" class="form-control form-control-solid" placeholder="Masukkan Jumlah" name="stock" value="{{ $incoming_item->stock }}" />
                                                            </div>
                                                            <!--end::Input group-->
