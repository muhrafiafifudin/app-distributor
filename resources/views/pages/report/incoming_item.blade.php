                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body py-3 pt-10">
                            <div class="row mb-10 flex-center mt-10">
                                ...
                                <div class="col-lg-1">
                                    <a href="" class="btn btn-primary" onclick="this.href='print-pdf-masuk/' + document.getElementById('fromDate').value + '/' + document.getElementById('toDate').value" target="_blank">Print</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Body-->
