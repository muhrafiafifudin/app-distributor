        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Barang
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">Halaman Barang</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">Menampilkan semua barang yang ada</span>
                            </h3>
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <div class="mb-13 text-center">
                                                    ...
                                                    <div class="text-gray-400 fw-bold fs-5">Form Untuk Menambah Data Barang</div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Scroll-->
                        ...
                        <div class="card-body py-3 pt-10">
                            ...
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table id="item_table" class="table table-striped border rounded gy-5 gs-7 dataTable no-footer">
                                    <thead>
                                                ...
                                                @role('admin|owner')
                                                    <td class="text-center">
                                                        <form action="{{ route('item.destroy', \Crypt::encrypt($item->id)) }}" method="post">
                                                            ...
                                                            <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_item_{{ $item->id }}" >
                                ...
                                @foreach ($items as $item)
                                    <!--begin::Modal - New Target-->
                                    <div class="modal fade" id="modal_edit_item_{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                        <!--begin::Modal dialog-->
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <!--begin::Modal content-->
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <div class="mb-13 text-center">
                                                        ...
                                                        <div class="text-gray-400 fw-bold fs-5">Form Untuk Mengubah Data Barang</div>
                                                    </div>
                                                    <!--end::Heading-->
                                                    <!--begin::Scroll-->
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_form" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                                        ...
                                                        <form class="form" action="{{ route('item.update', \Crypt::encrypt($item->id)) }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">Nama Barang</label>
                                                                <input type="text" class="form-control form-control-solid" placeholder="Masukkan Nama Barang" name="item" value="{{ $item->item }}" />
                                                            </div>
                                                            <!--end::Input group-->
