                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body px-10 px-lg-15 pt-0 pb-15">
                                                ...
                                                <div class="mb-13 text-center">
                                                    ...
                                                    <div class="text-gray-400 fw-bold fs-5">Form Untuk Penambahan Data Barang</div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Scroll-->
                                            ...
                                            @foreach ($items as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit" data-bs-toggle="modal" data-bs-target="#modal_edit_karyawan_{{ $item->id }}" >
